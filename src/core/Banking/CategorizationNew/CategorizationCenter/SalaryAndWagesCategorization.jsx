...
const SalaryAndWagesCategorization = ({setCategorizationState}) => {
  ...
  {(dialog === '' || dialog === 'file') && <label htmlFor="file">
      <Box className={dialog === 'file' && device === 'desktop' ? `${css.salaryandwagescategorization} ${css.uploadDone}` : css.salaryandwagescategorization} ref={dragfropref}  style={{height: device === 'mobile' && 'auto', padding: device === 'mobile' && '15px 0'}}>
        ...
        <img
                ...
                style={{ width: '60px' }}
          />
          <p className={css.uploadtext}>Upload Salary Sheet</p>
      ...
      <Box className={dialog === 'file' && device === 'desktop' ? `${css.salaryandwagescategorization} ${css.uploadDone}` : css.salaryandwagescategorization} ref={dragfropref}  style={{height: device === 'mobile' && 'auto', padding: device === 'mobile' && '15px 0'}}>
        ...
        <img
                ...
                style={{ width: '60px' }}
          />
          <p className={css.uploadtext}>Successfully Salary Sheet Uploaded</p>
...
export default SalaryAndWagesCategorization;
