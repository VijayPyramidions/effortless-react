...
const Internet = () => {
  ...
  const getServiceProviders = async () => {
    await RestApi(`bbps_billers?category=Broadband Postpaid&search=${search}`, {
      method: METHOD.GET,
      headers: {
        Authorization: `Bearer ${user.activeToken}`,
      },
      ...
      {!providerChange ? (
        <Stack>
          ...
          <Stack className={css.providersearchwrp}>
            ...
            <input
              type="search"
              placeholder="Search Broadband Company"
